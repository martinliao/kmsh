...
function mrbsCreateSingleEntry($starttime, $endtime, $entry_type, $repeat_id, $room_id,
                               $owner, $name, $phone1, $type, $description, $oldid = 0, $roomchange = false) {
    global $DB;
...
function mrbsCreateRepeatEntry($starttime, $endtime, $rep_type, $rep_enddate, $rep_opt,
                               $room_id, $owner, $name, $phone1, $type, $description, $rep_num_weeks, $oldrepeatid = 0) {
    global $DB;
...
function mrbsCreateRepeatingEntrys($starttime, $endtime, $rep_type, $rep_enddate, $rep_opt,
                                   $room_id, $owner, $name, $phone1, $type, $description, $rep_num_weeks, $roomchange = false, $oldid = 0) {
    ...
    if (empty($reps)) {
        ...
        $ret->id = mrbsCreateSingleEntry($starttime, $endtime, 0, 0, $room_id, $owner, $name, $phone1, $type, $description, $oldid, $roomchange);
        $ret->repeating = 0;
        $ret->requested = 1;
        $ret->created = 1;
