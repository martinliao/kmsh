...
<FORM NAME="main" ACTION="edit_entry_handler.php" METHOD="GET">
    ...
    <TABLE BORDER=0>
        ...
        <TR>
            <TD CLASS=CR><B><?php echo get_string('phone') ?></B></TD>
            <TD CLASS=CL><INPUT NAME="phone1" SIZE=40 VALUE="<?php echo htmlspecialchars($phone1, ENT_NOQUOTES) ?>"></TD>
        </TR>
                    ...
                    <tr>
                        <td><select name="rooms[]" multiple="yes">
                                ...
                                foreach ($rooms as $dbroom) {
                                    ...
                                    echo "<option $selected value=\"".$dbroom->id."\">".s($dbroom->room_name)." (".s(strip_tags($dbroom->description))." Capacity:$dbroom->capacity)";
