...
$sql = "SELECT area_id, area_name FROM {block_mrbs_room} AS r 
        JOIN {block_mrbs_area} AS a ON a.id = r.area_id 
        WHERE room_name = ?";

$area = $DB->get_record_sql($sql, array($room), IGNORE_MULTIPLE);
if ($area) {
