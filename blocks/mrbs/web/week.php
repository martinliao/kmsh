...
if ($pview != 1) {
    ...
    // Show all areas
    echo "<td width=\"30%\"><b>■".get_string('areas', 'block_mrbs')."</b><br>";
}
...
if ($area_list_format == "select") {
    ...
    foreach ($areas as $dbarea) {
        ...
        if ($dbarea->id == $area) {
            ...
            if ($pview != 1) {
                echo "<font color=\"blue\">$this_area_name</font></a><br>\n";
            }
        } else if ($pview != 1) {
...
if ($pview != 1) {
    ...
    echo "<td width=\"30%\"><b>■".get_string('rooms', 'block_mrbs')."</b><br>";
}
...
if ($area_list_format == "select") {
    ...
    foreach ($rooms as $dbroom) {
        ...
        if ($dbroom->id == $room) {
            ...
            $this_room_description = ($dbroom->description);
            if ($pview != 1) {
                echo "<font color=\"blue\">$this_room_name</font></a><br>\n";
            }
        } else if ($pview != 1) {
