...
$string['blockname'] = 'Meeting Room Booking Scheduling';
...
$string['bookingmoveerrormessage'] = 'There has been an error moving {$a->name}. <br/>
Booking room:{$a->area} {$a->oldroom}<br/>
Booking time:<a href="{$a->link}">{$a->date}</a> <br/>
New booking name:{$a->newbookingname}  <br/>
';
...
$string['downloadquery'] = 'Report download';
...
$string['filename'] = 'Room booking report';
...
$string['messageprovider:notification'] = 'MRBS notify';