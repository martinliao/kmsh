<?php
/**
 * SmartMenu course format forums view.php
 * @package    block
 ...
 */
    ...
    $PAGE->set_url('/blocks/smartmenu/format/forums/view.php', $urlparams);
    ...
    require($CFG->dirroot .'/blocks/smartmenu/format/forums/format.php');
    // Content wrapper end.
