<?php
/**
 * SmartMenu course format quizzes
 * @package    block
 ...
 */
    ...
    $PAGE->set_url('/blocks/smartmenu/format/quizzes/view.php', $urlparams);
    ...
    require($CFG->dirroot .'/blocks/smartmenu/format/quizzes/format.php');
    // Content wrapper end.
