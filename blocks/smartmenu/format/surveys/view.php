<?php
/**
 * SmartMenu course format for surveys 
 * @package    block
 ...
 */
    ...
    $PAGE->set_url('/blocks/smartmenu/format/surveys/view.php', $urlparams);
    ...
    require($CFG->dirroot .'/blocks/smartmenu/format/surveys/format.php');
    // Content wrapper end.
