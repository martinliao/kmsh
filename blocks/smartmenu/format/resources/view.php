<?php
/**
 * SmartMenu course format for resources
 * @package    block
 ...
 */
    ...
    //require_once($CFG->dirroot.'/blocks/smartmenu/format/renderer.php');
    ...
    $PAGE->set_url('/blocks/smartmenu/format/resources/view.php', $urlparams);
    ...
    $PAGE->set_pagetype('course-view-resources');    
    ...
    require($CFG->dirroot .'/blocks/smartmenu/format/resources/format.php');
    // Content wrapper end.
