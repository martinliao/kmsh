...
/* eslint-disable no-debugger, no-unused-vars, no-console */
 ...
 */
export const activityModules = (courseid, allowtypes) => {
console.log(allowtypes);
    const request = {
        methodname: 'block_smartmenu_get_course_content_items',
        args: {
            courseid: courseid,
