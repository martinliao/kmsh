 ...
 *
 * @module     block_smartmenu/activitychooser
...
import * as Repository from 'block_smartmenu/repository';
        ...
        return () => {
            if (!innerPromise) {
                innerPromise = new Promise((resolve) => {
                    resolve(Repository.activityModules(courseId, chooserConfig.allowtypes));
                });
            }
