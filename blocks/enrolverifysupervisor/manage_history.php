...
$params = array();
$url = new moodle_url('/blocks/enrolverifysupervisor/manage_history.php', $params);
...
$PAGE->navbar->add(get_string('verifyhistory', 'block_enrolverifysupervisor'));
$PAGE->set_heading(get_string('verifyhistory', 'block_enrolverifysupervisor'));
$PAGE->set_title(get_string('verifyhistory', 'block_enrolverifysupervisor'));
...
$verify_status = array('1'=>get_string('agree', 'block_enrolverifysupervisor'),'2'=>get_string('reject', 'block_enrolverifysupervisor'));
...
$table = new blocks_enrolverifysupervisor_verifyhistory_table($USER->id, $filters);
