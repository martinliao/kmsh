...
$functions = array(
    'enrol_waiting_get_instance_info' => array(
        'classname'   => 'enrol_waiting_external',
        'methodname'  => 'get_instance_info',
        'classpath'   => 'enrol/waiting/externallib.php',
        'description' => 'waiting enrolment instance information.',
        'type'        => 'read',
        'services'    => array(MOODLE_OFFICIAL_MOBILE_SERVICE),
    ),

    'enrol_waiting_enrol_user' => array(
        'classname'   => 'enrol_waiting_external',
