...
/**
 * A bulk operation for the waiting enrolment plugin to delete selected users enrolments.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_waiting_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('deleteselectedusers', 'enrol_waiting');
    }
     ...
     * @return enrol_waiting_deleteselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkdeleteenrolment', 'enrol_waiting');
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_waiting');

        return new enrol_waiting_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        if (!has_capability("enrol/waiting:unenrol", $manager->get_context())) {
            return false;
        }
