...
/**
 * A bulk operation for the supervisor  enrolment plugin to delete selected users enrolments.
 *
...
class enrol_supervisor_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('deleteselectedusers', 'enrol_supervisor');
    }
     ...
     * @return enrol_supervisor_deleteselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkdeleteenrolment', 'enrol_supervisor');
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_supervisor');

        return new enrol_supervisor_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        if (!has_capability("enrol/supervisor:unenrol", $manager->get_context())) {
            return false;
        }
