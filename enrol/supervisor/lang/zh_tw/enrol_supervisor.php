...
$string['expirymessageenrolledsubject'] = '主管審核選課過期通知';
$string['expirymessageenrollerbody'] = '在\'{$a->course}\' 課程的主管審核選課將會在下{$a->threshold} 過期，受影響的用戶有：

{$a->users}

要延長他們的選課，請到{$a->extendurl}';
$string['expirymessageenrollersubject'] = '主管審核選課過期通知';
...
$string['maxenrolledreached'] = '已經達到主管審核選課用戶數目的上限.';
$string['messageprovider:expiry_notification'] = '主管審核選課過期通知';
$string['messageprovider:verify_notification'] = '主管審核通知';
...
$string['pluginname'] = '主管審核選課';
$string['pluginname_desc'] = '透過主管審核選課外掛，用戶可以自己選擇想參加的課程。可以透過選課密碼保護課程。選課過程是透過人工選課外掛完成的，所以必須在課程中啟用這個外掛套件。';
$string['requirepassword'] = '必須設定選課密碼';
$string['requirepassword_desc'] = '在新課程必須設定選課密碼，而現有課程不能移除選課密碼。';
$string['role'] = '預設的被分配的角色';
$string['supervisor:config'] = '配置主管審核選課外掛套件';
$string['supervisor:manage'] = '管理已經選課的用戶';
$string['supervisor:unenrol'] = '將用戶從課程中退選';
$string['supervisor:unenrolself'] = '自己從課程中退選';
...
$string['status_desc'] = '在新課程啟用主管審核選課方式';
$string['status_help'] = '若關閉，所有的主管審核選課者會被停學，且新用戶無法選課。';
...
//$string['standbyenrol'] = '{$a}報名候補 (主管審核)';
...
$string['mail_applycoursetext'] = '您有一個來自主管審核選課的待審核通知,

請您登入平台後，進入\'儀表板\'頁面內的主管審核專區，針對未審核申請單進行簽核.
