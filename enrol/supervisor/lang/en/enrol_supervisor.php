...
/**
 * Strings for component 'enrol_supervisor', language 'en'.
 *
...
$string['cohortonly_help'] = 'Supervisor enrolment may be restricted to members of a specified cohort only. Note that changing this setting has no effect on existing enrolments.';
...
$string['defaultrole_desc'] = 'Select role which should be assigned to users during supervisor enrolment';
...
//$string['standbyenrol'] = '{$a} standby enrol (Supervisor)';
...
$string['expirymessageenrollersubject'] = 'Supervisor enrolment expiry notification';
$string['expirymessageenrollerbody'] = 'Supervisor enrolment in the course \'{$a->course}\' will expire within the next {$a->threshold} for the following users:

{$a->users}

To extend their enrolment, go to {$a->extendurl}';
$string['expirymessageenrolledsubject'] = 'Supervisor enrolment expiry notification';
...
Note: An enrolment key for the course must be specified in the supervisor enrolment settings as well as group enrolment keys in the group settings.';
$string['keyholder'] = 'You should have received this enrolment key from:';
$string['longtimenosee'] = 'Unenrol inactive after';
$string['longtimenosee_help'] = 'If users haven\'t accessed a course for a long time, then they are automatically unenrolled. This parameter specifies that time limit.';
$string['maxenrolled'] = 'Max enrolled users';
$string['maxenrolled_help'] = 'Specifies the maximum number of users that can supervisor enrol. 0 means no limit.';
$string['maxenrolledreached'] = 'Maximum number of users allowed to supervisor-enrol was already reached.';
$string['messageprovider:expiry_notification'] = 'Supervisor enrolment expiry notifications';
$string['messageprovider:verify_notification'] = 'Supervisor enrolment verify notifications';
$string['newenrols'] = 'Allow new enrolments';
$string['newenrols_desc'] = 'Allow users to supervisor enrol into new courses by default.';
...
$string['pluginname'] = 'Supervisor enrolment';
$string['pluginname_desc'] = 'The supervisor enrolment plugin allows users to choose which courses they want to participate in. The courses may be protected by an enrolment key. Internally the enrolment is done via the manual enrolment plugin which has to be enabled in the same course.';
$string['requirepassword'] = 'Require enrolment key';
$string['requirepassword_desc'] = 'Require enrolment key in new courses and prevent removing of enrolment key from existing courses.';
$string['role'] = 'Default assigned role';
$string['supervisor:config'] = 'Configure supervisor enrol instances';
$string['supervisor:holdkey'] = 'Appear as the supervisor enrolment key holder';
$string['supervisor:manage'] = 'Manage enrolled users';
$string['supervisor:unenrol'] = 'Unenrol users from course';
$string['supervisor:unenrolself'] = 'Unenrol supervisor from the course';
$string['sendcoursewelcomemessage'] = 'Send course welcome message';
$string['sendcoursewelcomemessage_help'] = 'When a user supervisor enrols in the course, they may be sent a welcome message email. If sent from the course contact (by default the teacher), and more than one user has this role, the email is sent from the first user to be assigned the role.';
$string['sendexpirynotificationstask'] = "Supervisor enrolment send expiry notifications task";
$string['showhint'] = 'Show hint';
$string['showhint_desc'] = 'Show first letter of the guest access key.';
$string['status'] = 'Allow existing enrolments';
$string['status_desc'] = 'Enable supervisor enrolment method in new courses.';
$string['status_help'] = 'If enabled together with \'Allow new enrolments\' disabled, only users who waiting enrolled previously can access the course. If disabled, this supervisor enrolment method is effectively disabled, since all existing supervisor enrolments are suspended and new users cannot self enrol.';
$string['syncenrolmentstask'] = 'Synchronise supervisor enrolments task';
...
You can enter course to learning:
  ...
  {$a->courseurl}';
$string['privacy:metadata'] = 'The supervisor enrolment plugin does not store any personal data.';
...
$string['departmentonly_help'] = 'Supervisor enrolment may be restricted to members of a specified department only. Note that changing this setting has no effect on existing enrolments.';
$string['institutiononly'] = 'Only institution members';
$string['institutiononly_help'] = 'Supervisor enrolment may be restricted to members of a specified institution only. Note that changing this setting has no effect on existing enrolments.';
$string['departmentnonmemberinfo'] = 'Only members of \'{$a}\' department can supervisor-enrol.';
$string['institutionnonmemberinfo'] = 'Only members of \'{$a}\' institution can supervisor-enrol.';
