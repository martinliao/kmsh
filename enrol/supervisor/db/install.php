...
function xmldb_enrol_supervisor_install() {
    global $CFG, $DB;
    $dbman = $DB->get_manager();
    $table = new xmldb_table('enrol');
    
    set_config('requirepassword', 0, 'enrol_supervisor');
    set_config('usepasswordpolicy', 0, 'enrol_supervisor');
    set_config('showhint', 0, 'enrol_supervisor');
    set_config('groupkey', 0, 'enrol_supervisor');
    set_config('maxenrolled', 0, 'enrol_supervisor');
