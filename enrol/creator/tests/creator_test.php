...
global $CFG;
require_once($CFG->dirroot.'/enrol/creator/lib.php');
require_once($CFG->dirroot.'/enrol/creator/locallib.php');

class enrol_creator_testcase extends advanced_testcase {

    public function test_basics() {
        $this->assertTrue(enrol_is_enabled('creator'));
        $plugin = enrol_get_plugin('creator');
        $this->assertInstanceOf('enrol_creator_plugin', $plugin);
        $this->assertEquals(1, get_config('enrol_creator', 'defaultenrol'));
        $this->assertEquals(ENROL_EXT_REMOVED_KEEP, get_config('enrol_creator', 'expiredaction'));
    }

    public function test_sync_nothing() {
        global $SITE;

        $creatorplugin = enrol_get_plugin('creator');
    ...
    public function test_longtimnosee() {
        ...
        $this->assertEquals(3, $DB->count_records('enrol', array('enrol'=>'creator')));
        $instance1 = $DB->get_record('enrol', array('courseid'=>$course1->id, 'enrol'=>'creator'), '*', MUST_EXIST);
        $instance2 = $DB->get_record('enrol', array('courseid'=>$course2->id, 'enrol'=>'creator'), '*', MUST_EXIST);
        $instance3 = $DB->get_record('enrol', array('courseid'=>$course3->id, 'enrol'=>'creator'), '*', MUST_EXIST);
    ...
    public function test_send_expiry_notifications() {
        ...
        /** @var $creatorplugin enrol_creator_plugin */
        $creatorplugin = enrol_get_plugin('creator');
        ...
        $this->assertEquals(4, $DB->count_records('enrol', array('enrol'=>'creator')));
        ...
        $instance4 = $DB->get_record('enrol', array('courseid'=>$course4->id, 'enrol'=>'creator'), '*', MUST_EXIST);
    ...
    public function test_show_enrolme_link() {
        ...
        // Cohort member test.
        $instance5 = $DB->get_record('enrol', array('courseid'=>$course5->id, 'enrol'=>'creator'), '*', MUST_EXIST);
        ...
        $instance7 = $DB->get_record('enrol', array('courseid'=>$course6->id, 'enrol'=>'creator'), '*', MUST_EXIST);
        ...
        $instance8 = $DB->get_record('enrol', array('courseid'=>$course7->id, 'enrol'=>'creator'), '*', MUST_EXIST);
        ...
        $instance9 = $DB->get_record('enrol', array('courseid'=>$course8->id, 'enrol'=>'creator'), '*', MUST_EXIST);
        ...
        $instance10 = $DB->get_record('enrol', array('courseid'=>$course9->id, 'enrol'=>'creator'), '*', MUST_EXIST);
        ...
        $instance11 = $DB->get_record('enrol', array('courseid'=>$course10->id, 'enrol'=>'creator'), '*', MUST_EXIST);
        ...
        $instance12 = $DB->get_record('enrol', array('courseid'=>$course11->id, 'enrol'=>'creator'), '*', MUST_EXIST);
     ...
     */
    public function test_can_creator_enrol() {
        ...
        $expectederrorstring = get_string('canntenrol', 'enrol_creator');
    ...
    /**
     * Test enrol_creator_check_group_enrolment_key
     */
    public function test_enrol_creator_check_group_enrolment_key() {
        global $DB;
        ...
        $result = enrol_creator_check_group_enrolment_key($course->id, 'invalidpassword');
        $this->assertFalse($result);

        $result = enrol_creator_check_group_enrolment_key($course->id, 'thepassword');
        ...
        $result = enrol_creator_check_group_enrolment_key($othercourse->id, 'thepassword');
        $this->assertFalse($result);
    ...
    public function test_get_welcome_email_contact() {
        ...
        // Enable creator enrolment plugin and set to send email from course contact.
        $creatorplugin = enrol_get_plugin('creator');
        $instance1 = $DB->get_record('enrol', ['courseid' => $course1->id, 'enrol' => 'creator'], '*', MUST_EXIST);
        $instance1->customint6 = 1;
        ...
        assign_capability('enrol/creator:holdkey', CAP_ALLOW, $managerrole->id, $context);
    ...
    public function test_get_user_enrolment_actions() {
        ...
        // Only enable the creator enrol plugin.
