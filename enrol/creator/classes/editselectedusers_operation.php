...
class enrol_creator_editselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('editselectedusers', 'enrol_creator');
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        ...
        if (!has_capability("enrol/creator:manage", $manager->get_context())) {
            return false;
        }
     ...
     * @return enrol_creator_editselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        return new enrol_creator_editselectedusers_form($defaultaction, $defaultcustomdata);
    }
}
