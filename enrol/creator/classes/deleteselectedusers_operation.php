...
/**
 * A bulk operation for the creator enrolment plugin to delete selected users enrolments.
 *
...
class enrol_creator_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
    ...
    public function get_title() {
        return get_string('deleteselectedusers', 'enrol_creator');
    }
     ...
     * @return enrol_creator_deleteselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        $defaultcustomdata['message'] = get_string('confirmbulkdeleteenrolment', 'enrol_creator');
        $defaultcustomdata['button'] = get_string('unenrolusers', 'enrol_creator');

        return new enrol_creator_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        if (!has_capability("enrol/creator:unenrol", $manager->get_context())) {
            return false;
        }
