...
$functions = array(
    'enrol_creator_get_instance_info' => array(
        'classname'   => 'enrol_creator_external',
        'methodname'  => 'get_instance_info',
        'classpath'   => 'enrol/creator/externallib.php',
        'description' => 'creator enrolment instance information.',
        'type'        => 'read',
        'services'    => array(MOODLE_OFFICIAL_MOBILE_SERVICE),
    ),

    'enrol_creator_enrol_user' => array(
        'classname'   => 'enrol_creator_external',
