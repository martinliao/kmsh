...
$string['canntenrolearly'] = '您還不能選課；選課開始於{$a}';
...
$string['expirymessageenrolledsubject'] = '課程管理員審核選課過期通知';
$string['expirymessageenrollerbody'] = '在\'{$a->course}\' 課程的課程管理員審核選課將會在下{$a->threshold} 過期，受影響的用戶有：

{$a->users}

要延長他們的選課，請到{$a->extendurl}';
$string['expirymessageenrollersubject'] = '課程管理員審核選課過期通知';
...
$string['maxenrolledreached'] = '已經達到課程管理員審核選課用戶數目的上限.';
$string['messageprovider:expiry_notification'] = '課程管理員選課過期通知';
$string['messageprovider:verify_notification'] = '課程管理員審核通知';
...
$string['pluginname'] = '課程管理員審核選課';
$string['pluginname_desc'] = '透過課程管理員審核選課外掛，用戶可以自己選擇想參加的課程。可以透過選課密碼保護課程。選課過程是透過人工選課外掛完成的，所以必須在課程中啟用這個外掛套件。';
$string['requirepassword'] = '必須設定選課密碼';
$string['requirepassword_desc'] = '在新課程必須設定選課密碼，而現有課程不能移除選課密碼。';
$string['role'] = '預設的被分配的角色';
$string['creator:config'] = '配置課程管理員審核選課外掛套件';
$string['creator:manage'] = '管理已經選課的用戶';
$string['creator:unenrol'] = '將用戶從課程中退選';
$string['creator:unenrolself'] = '自己從課程中退選';
...
$string['status_desc'] = '在新課程啟用課程管理員審核選課方式';
$string['status_help'] = '若關閉，所有的課程管理員審核選課者會被停學，且新用戶無法選課。';
...
即日起即可登入平台，進入課程開始學習:
  ...
  {$a->courseurl}';
$string['institutiononly'] = '指定職稱成員';
$string['departmentonly'] = '指定科室成員';
...
//$string['standbyenrol'] = '{$a}報名候補 (課程管理員審核)';
...
$string['notification_verify'] = '報名審核中';
$string['notification_reject'] = '審核未通過';
$string['mail_applycourse'] = '待審核通知 - {$a}';
$string['mail_applycoursetext'] = '您有一個來自課程管理員審核選課的待審核通知,

請您登入平台後，進入\'儀表板\'頁面內的課程管理員審核專區，針對未審核申請單進行簽核.
...
';
$string['mail_verifycourse'] = '\'{$a}\' -課程報名申請審核通知信';
$string['mail_verifycoursetext'] = '課程報名申請審核通知結果如下:
...
';
$string['verify_agree'] = '<font color=blue>核准</font>';
$string['verify_reject'] = '<font color=red>駁回 ({$a})</font>';
$string['unenrolenddaterror'] = '退選的結束日期不可以晚於課程結束日期';
