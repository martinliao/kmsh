<?php
/**
 * signin enrolment plugin - support for user signin unenrolment.
 * 
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'signin'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/signin/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_signin', format_string($course->fullname));
