<?php
/**
 * Strings for component 'enrol_self', language 'zh_tw', branch 'MOODLE_27_STABLE'
 * 
...
$string['cohortnonmemberinfo'] = '只有校定班級群組\'{$a}\'的成員可以簽到選課';
$string['cohortonly'] = '只有校定班級群組成員';
$string['cohortonly_help'] = '教師可以限制為只有指定的校定班級群組的成員才簽到選課。注意，改變這一設定對於已經選課的用戶沒有影響。';
...
$string['defaultrole_desc'] = '選擇當用戶簽到選課時，被指派的角色';
$string['enrolenddate'] = '結束日期';
$string['enrolenddate_help'] = '如果啟用，用戶只能在此日期前簽到加入此課程。';
...
$string['enrolperiod_help'] = '選課有效的時間長度，從用戶簽到加入課程的那一刻算起。若停用此項，表示選課期間沒有限制。';
$string['enrolstartdate'] = '開始日期';
$string['enrolstartdate_help'] = '若啟用，用戶只能在此日期之後簽到加入此課程。';
...
$string['expirymessageenrolledsubject'] = '簽到選課過期通知';
$string['expirymessageenrollerbody'] = '在\'{$a->course}\' 課程的簽到選課將會在下{$a->threshold} 過期，受影響的用戶有：

{$a->users}

要延長他們的選課，請到{$a->extendurl}';
$string['expirymessageenrollersubject'] = '簽到選課過期通知';
...
$string['maxenrolled_help'] = '指定可以簽到選課的最大用戶數目。0表示無限制。';
$string['maxenrolledreached'] = '已經達到簽到選課用戶數目的上限。';
$string['messageprovider:expiry_notification'] = '簽到選課過期通知';
$string['newenrols'] = '允許新的選課';
$string['newenrols_desc'] = '預設為允許用戶簽到選修新課程';
...
$string['pluginname'] = '簽到選課';
$string['pluginname_desc'] = '透過簽到選課外掛，用戶可以自己選擇想參加的課程。可以透過選課密碼保護課程。選課過程是透過人工選課外掛完成的，所以必須在課程中啟用這個外掛套件。';
$string['requirepassword'] = '必須設定選課密碼';
$string['requirepassword_desc'] = '在新課程必須設定選課密碼，而現有課程不能移除選課密碼。';
$string['role'] = '預設的被分配的角色';
$string['self:config'] = '配置簽到選課外掛套件';
...
$string['sendcoursewelcomemessage_help'] = '若啟用，當用戶簽到選課時，會透過email收到一封歡迎的信。';
$string['showhint'] = '顯示提示';
$string['showhint_desc'] = '顯示訪客密碼的第一個字母';
$string['status'] = '啟用現有選課方式';
$string['status_desc'] = '在新課程啟用簽到選課方式';
$string['status_help'] = '若關閉，所有的簽到選課者會被停學，且新用戶無法選課。';
