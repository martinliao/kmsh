...
/**
 * Strings for component 'auth_kmsh', language 'en'.
 *
 * @package    auth_kmsh
...
$string['auth_dbpasstype'] = '<p>Specify the format that the password field is using.</p> <p>Use \'internal\' if you want the external database to manage usernames and email addresses, but Moodle to manage passwords. If you use \'internal\', you must provide a populated email address field in the external database, and you must enable the \auth_kmsh\task\sync_users scheduled task. Moodle will send an email to new users with a temporary password.</p>';
...
$string['pluginname'] = 'KMSH database';
$string['privacy:metadata'] = 'The External database authentication plugin does not store any personal data.';

$string['auth_dbsynccohorttask'] = 'Synchronise users cohort task';
$string['auth_dbname_profile_key'] = 'DB name(Profile)';
$string['auth_dbuser_profile_key'] = 'DB user(Profile)';
$string['auth_dbpass_profile_key'] = 'Password(Profile)';