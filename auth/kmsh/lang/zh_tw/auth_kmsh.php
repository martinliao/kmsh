...
/**
 * Strings for component 'auth_kmsh', language 'zh_tw', version '3.9'.
 *
 * @package    auth_kmsh
...
若你已經選用，你必須在外部資料庫中提供一個email地址欄位，而且你必須定期的執行admin/cron.php 和 auth/kmsh/cli/sync_users.php 兩個程式。
...
$string['pluginname'] = 'KMSH資料庫';

$string['auth_dbname_profile_key'] = '資料庫名稱(個資)';
$string['auth_dbuser_profile_key'] = '資料庫用戶(個資)';
$string['auth_dbpass_profile_key'] = '密碼(個資)';